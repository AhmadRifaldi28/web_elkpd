                ...
                <div class="col-lg-6 col-xl-4 mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <p class="card-text"><?= htmlspecialchars($sekolah->address, ENT_QUOTES, 'UTF-8'); ?></p>
                        </div>
                        <div class="card-footer bg-light d-flex justify-content-end">
                            <a href="<?= base_url('guru/dashboard/detail/' . $sekolah->id) ?>" class="btn btn-primary btn-icon-split">
