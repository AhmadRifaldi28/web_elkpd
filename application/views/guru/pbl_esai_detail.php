    ...
    <div class="pagetitle mb-3">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?= htmlspecialchars($essay->description, ENT_QUOTES, 'UTF-8'); ?>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="col-lg-12 mb-4">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 text-primary"><i class="bi bi-question-circle"></i> Daftar Pertanyaan
                    </h5>
                    <div class="d-flex gap-2">
                        <button class="btn btn-primary btn-sm" id="btnAddQuestion">
                            <i class="bi bi-plus-circle me-1"></i> Tambah Soal
                        </button>
                        <a href="<?= base_url($url_name . '/pbl_esai/panduan_detail_esai/' . $class_id); ?>"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-7 border-end">
                            ...
                            <div class="p-3 bg-light rounded" id="studentAnswerContent"
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="grade" id="gradeInput" class="form-control" min="0" max="100"
                                    required>
                            </div>
                            <div class="mb-3">
