...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const quizConfig = {
    ...
    dataMapper: (q, i) => {
      const detailBtn = `<a href="${window.BASE_URL}${window.URL_NAME}/pbl_kuis/kuis_detail/${q.id}" class="btn btn-sm btn-bd-primary"> Kerjakan</a>`;
  ...
  const ttsConfig = {
    ...
    // Data Mapper TTS
    dataMapper: (t, i) => {
      const detailBtn = `<a href="${window.BASE_URL}${window.URL_NAME}/pbl_tts/detail/${t.id}" class="btn btn-bd-primary btn-sm me-1"> Kerjakan</a>`;
